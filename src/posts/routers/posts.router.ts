...
postsRouter.get("/:id", idValidationPosts, inputValidationResultMiddleware, getPostHandler);

postsRouter.delete("/:id",idValidationPosts, superAdminGuardMiddleware,  inputValidationResultMiddleware, deletePostHandler);

postsRouter.post("", superAdminGuardMiddleware, postsInputDtoValidation, inputValidationResultMiddleware, createPostHandler);

postsRouter.put("/:id", idValidationPosts, superAdminGuardMiddleware, postsInputDtoValidation, inputValidationResultMiddleware, updatePostHandler);
